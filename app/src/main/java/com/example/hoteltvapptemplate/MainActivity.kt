...
import com.example.hoteltvapptemplate.presenter.applications.ApplicationsViewModel
import com.example.hoteltvapptemplate.presenter.NavigationHandler
import com.example.hoteltvapptemplate.presenter.applications.ApplicationsScreen
...
fun MainScreen(
    ...
    NavHost(
        ...
        composable("applicationsScreen") {
            ApplicationsScreen(screenParameters)
        }
